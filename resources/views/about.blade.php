...
@section('content')
    <div class="site-wrap">
            ...
            <div class="site-section @if($blocks->color) bg-{{$blocks->color}} @endif">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 @if($blocks->position == 'right') order-md-2 @endif" data-aos="fade-up"
                             data-aos-delay="100">
                            <img src="{{asset('uploads/pages/'.$blocks->image)}}" alt="Image" class="img-fluid">
                        </div>
                        <div class="col-md-5 @if($blocks->position == 'right') mr-auto order-md-1 @endif "
        ...
        @endforeach
        @if($leadership)
            @include('templates.leadership', ['employees'    => $leadership])
        @endif
